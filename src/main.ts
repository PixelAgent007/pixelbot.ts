...
import { EmbedBuilder, Guild, GuildMember, IntentsBitField, MessagePayload, TextChannel } from "discord.js";
...
bot.once("ready", async () => {
    ...
    for (guild of bot.guilds.cache) {
        ...
        const channel = guild[1].channels.cache.find((channel) => channel.type === ChannelType.GuildText) as TextChannel;
